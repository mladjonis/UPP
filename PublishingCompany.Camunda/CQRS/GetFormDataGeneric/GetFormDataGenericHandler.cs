...
{
    public class GetFormDataGenericHandler : IRequestHandler<GetFormDataGenericRequest, GetFormDataGenericResponse>
    {
        private readonly IMapper _mapper;
        private readonly BpmnService _bpmnService;

        public GetFormDataGenericHandler(IMapper mapper, BpmnService bpmnService)
        {
            _mapper = mapper;
            _bpmnService = bpmnService;
        }

        public async Task<GetFormDataGenericResponse> Handle(GetFormDataGenericRequest request, CancellationToken cancellationToken)
        {
            ...
            var registerUserResponse = _mapper.Map<GetFormDataGenericResponse>(formData);
